...
mkdir -p $CKEDITOR_TRUNK/_source/plugins/imagepaste/
...
java -jar $CKEDITOR_TRUNK/_dev/releaser/ckreleaser/ckreleaser.jar $CKEDITOR_TRUNK/_dev/releaser/ckreleaser.release $CKEDITOR_TRUNK/ ./$CKEDITOR_RELEASE/ "trunk" ckeditor_trunk --run-before-release=$LANGTOOL
